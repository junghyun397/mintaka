# mintaka
*Try [mintaka WebUI](https://renju.do1ph.in) in your browser.*

(WIP) [mintaka](https://en.wikipedia.org/wiki/Mintaka) is a Renju engine written in Rust, currently in pre-alpha and under active development;
...
- **Core Engine**
  ...
  - Advanced tree search algorithm based on [Principal Variation Search](https://en.wikipedia.org/wiki/Principal_variation_search) with a dedicated endgame solver
...
- **Interfaces**
  ...
  - FFI Bindings: C abi and WebAssembly (JavaScript/TypeScript)
  - REST api: axum server with session-persistent reload

- **Planned**
  - [NNUE](https://en.wikipedia.org/wiki/Efficiently_updatable_neural_network) and [AlpaZero](https://en.wikipedia.org/wiki/AlphaZero)-based evaluation with separate networks for black/white pieces
  - Opening book support for early game cutoff

## Getting Started
[mintaka WebUI](https://renju.do1ph.in)(WASM) or your native machine:
